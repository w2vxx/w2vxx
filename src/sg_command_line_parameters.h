#ifndef SG_COMMAND_LINE_PARAMETERS_H_
#define SG_COMMAND_LINE_PARAMETERS_H_

#include "command_line_parameters.h"

class SgCommandLineParameters : public CommandLineParameters
{
public:
  SgCommandLineParameters()
  {
...
#endif /* SG_COMMAND_LINE_PARAMETERS_H_ */
